...
<div class="col d-flex">
    <div id="autonomo-{{ \App\Helpers\Helpers::getId($autonomo['_id']) }}"
        class="autonomo-card card swiper-slide h-100 d-flex flex-column {{ isset($classCard) ? $classCard : '' }}"
        ...
        <div class="card-body bg-white w-100 d-flex flex-column align-items-start rounded-bottom border-bottom border-1">
            ...
            <div class="mt-auto d-flex justify-content-between w-100 align-items-center mt-2">
