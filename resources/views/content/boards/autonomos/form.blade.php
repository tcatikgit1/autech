...
@section('content')
    ...
    <!-- Sticky Actions -->
    <form id="board-form" action="{{route('employee.store', ['id' => @$employee['_id']])}}" method="post" enctype="multipart/form-data">
        @csrf
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header sticky-element bg-label-light d-flex justify-content-sm-between align-items-sm-center flex-column flex-sm-row">
                    ...
                    <div class="action-btns">
                        <a type="button" href="{{route('employee.index')}}" class="btn btn-label-danger me-4">
                            ...
                            <div class="row g-6">
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex align-items-start align-items-sm-center gap-6">
                                        <img src="{{isset($avatar) ? $avatar : asset('assets/img/icons/forms/upload.png')}}" alt="user-avatar" class="d-block w-px-100 h-px-100 rounded" id="uploadedFile">
                                        <div class="button-wrapper">
                                            ...
                                            <div>Allowed JPG or PNG. Max size of 500K. Recommended 100x100 px</div>
                                        </div>
                                    </div>
                                </div>
